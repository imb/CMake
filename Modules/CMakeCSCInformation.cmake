...
SET(CMAKE_CSC_OUTPUT_EXTENSION       .o)
SET(CMAKE_CSC_IMPORT_LIBRARY_PREFIX  .lib)
...
SET(CMAKE_CSC_CREATE_SHARED_LIBRARY 
    "<CMAKE_CSC_COMPILER> shared_library /nologo /target:library /out:<TARGET> ---target_implib <TARGET>:<TARGET_IMPLIB> ---objects <OBJECTS>"
) 
...
SET(CMAKE_CSC_LINK_EXECUTABLE 
    "<CMAKE_CSC_COMPILER> link_executable /nologo /target:exe /out:<TARGET> ---objects <OBJECTS> ---link_libraries <LINK_LIBRARIES>"
)
